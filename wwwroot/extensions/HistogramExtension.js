...
//CREACION DE LA NUEVA SECCIÓN O BARRA DE HERRAMIENTAS DEL VISOR E INTEGRACIÓN DE LOS BOTONES NUEVOS
    onToolbarCreated() {
        this._barChartPanel = new HistogramPanel(this, 'dashboard-barchart-panel', 'GRAFICO DE BARRAS', { x: 10, y: 10, chartType: 'bar' });
        ...
        this._pieChartButton.onClick = () => {
            ...
            if (this._pieChartPanel.isVisible() && this.viewer.model) {
                this._pieChartPanel.setModel(this.viewer.model); // en este punto se llama a la funcion que dinamisa el panel
            }
        };
    }
